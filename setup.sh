...
sudo apt-get install -y zsh htop git curl tldr build-essential libssl-dev snapd direnv stow tmux
...
begin "tpm for tmux" "because everything needs plugin manager"
git clone https://github.com/tmux-plugins/tpm ~/.tmux/plugins/tpm
finished "tpm for tmux"
...
begin "homebrew" "ever MOAR packages"
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)"
finished "homebrew"

begin "python & rust (and neovim)" "because programming is fun, right?"
sudo apt-get install -y python3-pip python3-venv python3-dev gparted kazam ncdu
